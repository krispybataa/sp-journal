...
%% ------------------------------------------------------------
\title[Alagang MMC]{Alagang MMC: A Human-Centered Care Coordination
  System for Makati Medical Center via the CeHRes Roadmap}
...
% \email{adviser-email@up.edu.ph}    % Add adviser's email if co-authoring
\affiliation{%
  \institution{University of the Philippines Manila}
  \department{Department of Physical Sciences and Mathematics}
  \city{Manila}
